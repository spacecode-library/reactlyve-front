  ...
  return (
    <MainLayout> {/* Added MainLayout wrapper */}
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="mb-1">INTELLECTUAL PROPERTY RIGHTS</p>
        <p className="mb-1">USER REPRESENTATIONS</p>
        <p className="mb-1">USER REGISTRATION</p>
        <p className="mb-1">PROHIBITED ACTIVITIES</p>
        <p className="mb-1">USER GENERATED CONTRIBUTIONS</p>
        <p className="mb-1">CONTRIBUTION LICENCE</p>
        <p className="mb-1">SERVICES MANAGEMENT</p>
        <p className="mb-1">PRIVACY POLICY</p>
        <p className="mb-1">COPYRIGHT INFRINGEMENTS</p>
        <p className="mb-1">TERM AND TERMINATION</p>
        <p className="mb-1">MODIFICATIONS AND INTERRUPTIONS</p>
        <p className="mb-1">GOVERNING LAW</p>
        <p className="mb-1">DISPUTE RESOLUTION</p>
        <p className="mb-1">CORRECTIONS</p>
        <p className="mb-1">DISCLAIMER</p>
        <p className="mb-1">LIMITATIONS OF LIABILITY</p>
        <p className="mb-1">INDEMNIFICATION</p>
        <p className="mb-1">USER DATA</p>
        <p className="mb-1">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</p>
        <p className="mb-1">CALIFORNIA USERS AND RESIDENTS</p>
        <p className="mb-1">MISCELLANEOUS</p>
        <p className="mb-1">CONTACT US</p>

        <h2 className="text-2xl font-semibold mt-6 mb-3">1. OUR SERVICES</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">3. USER REPRESENTATIONS</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">4. USER REGISTRATION</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">6. USER GENERATED CONTRIBUTIONS</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">7. CONTRIBUTION LICENSE</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">8. SERVICES MANAGEMENT</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">10. COPYRIGHT INFRINGEMENTS</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">11. TERM AND TERMINATION</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">12. MODIFICATIONS AND INTERRUPTIONS</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">14. DISPUTE RESOLUTION</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">15. CORRECTIONS</h2>
        <p className="mb-2">
          There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.
        </p>

        <h2 className="text-2xl font-semibold mt-6 mb-3">16. DISCLAIMER</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">17. LIMITATIONS OF LIABILITY</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">18. INDEMNIFICATION</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">19. USER DATA</h2>
        <p className="mb-2">
          We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.
        </p>

        <h2 className="text-2xl font-semibold mt-6 mb-3">20. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">21. CALIFORNIA USERS AND RESIDENTS</h2>
        <p className="mb-2">
          If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.
        </p>

        <h2 className="text-2xl font-semibold mt-6 mb-3">22. MISCELLANEOUS</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">23. CONTACT US</h2>
        <p className="mb-2">
