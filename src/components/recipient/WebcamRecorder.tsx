...
//   // Initialize webcam first, separate from auto-start logic
//   useEffect(() => {
...
//       stopRecording();
//     };
//   }, [isBrowserSupported, startWebcam, stopWebcam, stopRecording, onPermissionDenied, webcamInitialized]);

//   // Handle auto-start separately after webcam is initialized
//   useEffect(() => {
//     if (webcamInitialized && autoStart && stream && permissionState === 'granted') {
//       // Start countdown and recording
//       setShowCountdown(true);
    
//     }
    
//   }, [webcamInitialized, autoStart, stream, permissionState]);
...
//         // In autoStart mode, we start recording after webcam is ready
//         if (autoStart && stream) {
//           // If we want to start without countdown in autoStart mode
//           startRecording();
//           setIsRecording(true);
//           console.log('Recording started immediately after webcam initialization');
//         }
//       } catch (error) {
//         console.error('Failed to start webcam:', error);
...
//       stopRecording();
//     };
//   }, [isBrowserSupported, startWebcam, stopWebcam, stopRecording, onPermissionDenied, webcamInitialized, retryCount, autoStart, stream]);
...
//   // Custom countdown timer implementation
//   useEffect(() => {
...
//       if (countdownInterval) clearInterval(countdownInterval);
//     };
//   }, [showCountdown, countdownValue, stream, startRecording, onCountdownComplete]);
...
//   const handleStartRecording = () => {
//     // Check if webcam is initialized and we have a stream
//     if (webcamInitialized && stream && recordingStatus === 'inactive') {
//       console.log('Starting countdown before recording');
//       setShowCountdown(true);
//     } else if (webcamInitialized && !stream) {
//       // Stream is not available even though webcam is initialized
//       console.warn('Cannot start countdown: Stream not available');
      
//       // Try to reinitialize webcam
//       setWebcamInitialized(false);
//       setRetryCount(0);
      
//       // Show user-friendly error
//       setPermissionError('Camera stream not available. Attempting to reconnect...');
//     } else {
//       console.warn('Cannot start countdown: webcam not ready or recording already active');
//     }
//   };
